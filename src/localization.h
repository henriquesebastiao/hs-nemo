  ...
  #define TXT_WF_SPAM_FUN_BR "Spam Funny (BR)"
  ...
  #define TXT_WF_SPAM_FUN_BR "Spam Engracado (BR)"
  #define TXT_WF_SPAM_RR "Spam Rickroll"
  ...
  #define TXT_INST_NXT "Prox: Seta p/ Baixo"
  #define TXT_INST_PRV "Ante: Seta p/ Cima"
  #define TXT_INST_SEL "Sel : Enter ou ->"
  #define TXT_INST_HOME "Menu: Esc   ou <-"
